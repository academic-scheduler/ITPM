...
// //     try {
// //       console.log('Fetching room details for Room ID:', roomId); // Debugging line
// //       const response = await api.get(`api/room-allocation/rooms/${roomId}/`);
// //       console.log('Room Details:', response.data); // Debugging line
...
// //     try {
// //       console.log('Fetching instructor details for Instructor ID:', instructorId); // Debugging line
// //       const response = await api.get(`api/get-user-details/?user_id=${instructorId}`);
// //       console.log('Instructor Details:', response.data); // Debugging line
...
// //           backgroundColor: 'rgba(0, 0, 0, 0.8)', // Light black (semi-transparent)
// //           color: 'white', // Text color
// //           padding: '20px',
// //           boxShadow: '0 0 10px rgba(255, 255, 255, 0.1)', // Light shadow
// //           zIndex: 1000,
...
// //         {/* <p><strong>Is Staff:</strong> {instructor.is_staff ? 'Yes' : 'No'}</p>
// //         <p><strong>Is Active:</strong> {instructor.is_active ? 'Yes' : 'No'}</p> */}
// //         <button
// //           onClick={onClose}
// //           style={{
// //             backgroundColor: '#007bff',
...
//               <th style={{ padding: '10px', border: '1px solid #ddd' }}>Instructor ID</th>
//               <th style={{ padding: '10px', border: '1px solid #ddd' }}>Room ID</th>
